...
public abstract class DebugData {
    ...
    public static class PlacedText extends DebugData {
        ...
        public PlacedText(ai_cup_22.model.Vec2 position, String text, ai_cup_22.model.Vec2 alignment, double size, Color color) {
    ...
    public static class Circle extends DebugData {
        ...
        public Circle(ai_cup_22.model.Vec2 position, double radius, Color color) {
            this.position = position;
            this.radius = radius;
            this.color = color;
        }
    ...
    public static class GradientCircle extends DebugData {
        ...
        public GradientCircle(ai_cup_22.model.Vec2 position, double radius, Color innerColor, Color outerColor) {
            this.position = position;
            this.radius = radius;
    ...
    public static class Ring extends DebugData {
        ...
        public Ring(ai_cup_22.model.Vec2 position, double radius, double width, Color color) {
            this.position = position;
            this.radius = radius;
            this.width = width;
            this.color = color;
    ...
    public static class Pie extends DebugData {
        ...
        public Pie(ai_cup_22.model.Vec2 position, double radius, double startAngle, double endAngle, Color color) {
            this.position = position;
            this.radius = radius;
    ...
    public static class Arc extends DebugData {
        ...
        public Arc(ai_cup_22.model.Vec2 position, double radius, double width, double startAngle, double endAngle, Color color) {
            this.position = position;
            this.radius = radius;
            this.width = width;
            this.startAngle = startAngle;
    ...
    public static class Rect extends DebugData {
        ...
        public Rect(ai_cup_22.model.Vec2 bottomLeft, ai_cup_22.model.Vec2 size, Color color) {
    ...
    public static class Polygon extends DebugData {
        ...
        public Polygon(ai_cup_22.model.Vec2[] vertices, Color color) {
    ...
    public static class Segment extends DebugData {
        ...
        public Segment(ai_cup_22.model.Vec2 firstEnd, ai_cup_22.model.Vec2 secondEnd, double width, Color color) {
    ...
    public static class GradientSegment extends DebugData {
        ...
        public GradientSegment(ai_cup_22.model.Vec2 firstEnd, Color firstColor, ai_cup_22.model.Vec2 secondEnd, Color secondColor, double width) {
            this.firstEnd = firstEnd;
    ...
    public static class PolyLine extends DebugData {
        ...
        public PolyLine(ai_cup_22.model.Vec2[] vertices, double width, Color color) {
            this.vertices = vertices;
            this.width = width;
            this.color = color;
        }
