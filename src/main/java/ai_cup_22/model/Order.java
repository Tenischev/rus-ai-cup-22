...
public class Order {
     ...
     */
    private java.util.Map<Integer, UnitOrder> unitOrders;

    /**
     * Orders for each of your units
     */
    public java.util.Map<Integer, UnitOrder> getUnitOrders() {
        return unitOrders;
    }
     ...
     * Orders for each of your units
     */
    public void setUnitOrders(java.util.Map<Integer, UnitOrder> value) {
        this.unitOrders = value;
    }

    public Order(java.util.Map<Integer, UnitOrder> unitOrders) {
    ...
    public static Order readFrom(java.io.InputStream stream) throws java.io.IOException {
        java.util.Map<Integer, UnitOrder> unitOrders;
    ...
    public void writeTo(java.io.OutputStream stream) throws java.io.IOException {
        ...
        for (java.util.Map.Entry<Integer, UnitOrder> unitOrdersEntry : unitOrders.entrySet()) {
